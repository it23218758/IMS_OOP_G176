...
<div class = "navdiv">
    <div class = "logo"> <a href = "/OOPDemoApp/"><img src = "views/img/SLIIT IMS.png"></a></div>
    <nav class = "navbar">
        <ul>
...
<footer>
    <div class="footer" >
        ...
        <div style = "height:250px; width: 600px; float:left; align-content: center; position: absolute; left:30%;">
            <a  href = "/OOPDemoApp/"><img src = "views/img/SLIIT IMS.png" style = "width: 220px ; height:180px; margin-left: 29%; border-radius: 10% ; " ></a>
